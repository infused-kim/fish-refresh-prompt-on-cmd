...
- [1. Instructions](#1-instructions)
  ...
  - [1.2. Usage](#12-usage)
    - [1.2.1. What to do if the prompt is not refreshing](#121-what-to-do-if-the-prompt-is-not-refreshing)
    - [1.2.2. How to enable debug logging](#122-how-to-enable-debug-logging)
    - [1.2.3. How to configure your prompt to use `rpoc_time`](#123-how-to-configure-your-prompt-to-use-rpoc_time)
    - [1.2.4. How to change the prompt output when the prompt is refreshing](#124-how-to-change-the-prompt-output-when-the-prompt-is-refreshing)
    - [1.2.5. How to disable the automatic time right prompt](#125-how-to-disable-the-automatic-time-right-prompt)
    - [1.2.6. How to disable refreshing on the left or right side](#126-how-to-disable-refreshing-on-the-left-or-right-side)
    - [1.2.7. How to customize the time prompt](#127-how-to-customize-the-time-prompt)
    - [1.2.8. How to customize the command duration prompt](#128-how-to-customize-the-command-duration-prompt)
...
- [3. Known Issues](#3-known-issues)
  - [3.1. fish-async-prompt sometimes not repainting](#31-fish-async-prompt-sometimes-not-repainting)
...
#### 1.2.1. What to do if the prompt is not refreshing
...
#### 1.2.2. How to enable debug logging
...
#### 1.2.3. How to configure your prompt to use `rpoc_time`
...
#### 1.2.4. How to change the prompt output when the prompt is refreshing
...
#### 1.2.5. How to disable the automatic time right prompt
...
#### 1.2.6. How to disable refreshing on the left or right side
...
#### 1.2.7. How to customize the time prompt
...
#### 1.2.8. How to customize the command duration prompt
...
### 3.1. fish-async-prompt sometimes not repainting
